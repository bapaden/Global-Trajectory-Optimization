...
plt.save("shortest_path_demo.png")
...
#Load results from txt file
path = np.transpose(np.genfromtxt('nonholonomic_path_demo.txt', delimiter=','))
nodes = np.transpose(np.genfromtxt('nonholonomic_path_nodes.txt', delimiter=','))
...
ax.add_patch(Circle([6.0, 8.0],2.0, facecolor="black",alpha=0.7,edgecolor="none"))
ax.add_patch(Circle([10.0, 10.0],0.5, facecolor="green",alpha=0.3,edgecolor="none"))
plt.save("nonholonomic_path_demo.png")
